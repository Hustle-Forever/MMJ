...
import { FullscreenMenu, type NavLinkItem } from "./FullscreenMenu";
...
/**
 * Sticky site nav — transparent at the top, softens to a blurred blush
 * glass once scrolled. Menu + links left, logo centered, cart right.
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Link
            to="/"
            className="flex min-h-11 items-center justify-center focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
