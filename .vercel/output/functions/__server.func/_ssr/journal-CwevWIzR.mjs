...
//#region node_modules/.nitro/vite/services/ssr/assets/journal-CwevWIzR.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Nav, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Journal · Coming soon"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "font-display text-h1 text-blue",
					children: "Stories from the page."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-6 max-w-sm text-[16px] leading-[1.75] text-blue/55",
					children: "Essays, rituals, and reasons to write by hand."
				}),
